...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=deadlock-coach,service.version={commit_sha}",
        )
    ...
    # In prototype mode we allow this to degrade cleanly if cloud exporters
    # are unavailable or optional packages were not installed.
    try:
    ...
    except Exception as exc:  # pragma: no cover - depends on local/cloud env
        logging.warning("Telemetry exporters unavailable in prototype mode: %s", exc)
        project_id = None
