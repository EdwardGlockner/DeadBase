...
- url: https://deadlock.wiki/Grey_Talon/Update_history
- imported_at: 2026-07-10T07:09:05+00:00

Reference extract:

This page documents the full update history for Grey Talon.

| Update | Changes |

| --- | --- |

| June 30, 2026 | Rain of Arrows cooldown increased from 23s to 25s. Guided Owl permanent spirit bonus reduced from 10 to 8. Guided Owl cooldown increased from 110s to 125s. (Global ult change) Guided Owl T2 reduced from -45s Cooldown to -40s. (Global ult change) |

| June 11, 2026 | Gun cycle time increased from 0.5775 to 0.6 (~4% DPS nerf). Bullet damage growth reduced from +1.0 to +0.85. Rain of Arrows cooldown increased from 22s to 23s. Rain of Arrows T2 reduced from -13s Cooldown to -12s. |

| May 22, 2026 | Rain of Arrows cooldown reduced from 30s to 22s. Rain of Arrows cast delay reduced from 0.5s to 0.2s. Rain of Arrows duration reduced from 7s to 4s. Rain of Arrows moving ability in air improved. Rain of Arrows stamina distance changed from -9% to +25%. Rain of Arrows Weapon Damage bonus reduced from +4 to +3. Rain of Arrows T1 changed from "-14s Cooldown" to "+3 Weapon Damage and +30% Slow for 1.5s". Rain of Arrows T2 changed from "+5 Weapon Damage and +40% Slow for 1.5s" to "-13s Cooldown" (Total CD from 16s to 9s). |
