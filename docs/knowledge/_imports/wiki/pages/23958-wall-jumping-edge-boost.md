# Wall Jumping/Edge Boost

Imported reference

- kind: pages
- source: Deadlock Wiki
- url: https://deadlock.wiki/Wall_Jumping/Edge_Boost
- imported_at: 2026-07-10T07:15:03+00:00

Reference extract:

| Edge Boosting | Tech Type: |

| --- | --- |

| Load video Local File Local File might collect personal data. Continue Dismiss https://deadlock.wiki/File:Edgeboost.mp4 |  |
...
| Edge Boosting (Wall Detection Style 2) | Tech Type: |

| --- | --- |

| Load video Local File Local File might collect personal data. Continue Dismiss https://deadlock.wiki/File:Edgeboostwcmd.mp4 |  |

| Tech Type: | Universal Tech |

| Inputs: | Use the command citadel_wall_detection_style 2 |

| Notes: | Take note of the direction of the arrow; because your collision capsule is rounded, there are normals where it points away from your current momentum and others where it is nearly parallel to your direction. |
