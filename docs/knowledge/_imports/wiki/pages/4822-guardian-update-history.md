...
- url: https://deadlock.wiki/Guardian/Update_history
...
| June 30, 2026 | Guardian bounty reduced from 1500 to 1250 |

| May 22, 2026 | Guardians scaling resistance from +75%->-50% over 12 minutes to +50%->-50% (takes more damage early) Shrines are now invulnerable until one pair of Base Guardians are destroyed Base Guardian Bullet Resistance increased from 10% to 20% |
